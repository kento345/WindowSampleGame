...
bool bullet_Polygon::create(const device& device)noexcept {
...
bool bullet_Polygon::createIndexBuffer(const device& device)noexcept {
	uint16_t indices[] = {
		//四角形
		0,1,2,3
	};
...
void bullet_Polygon::draw(const command_list& command_list)noexcept {
	//四角形
